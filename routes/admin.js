...
router.get('/analytics', async (req, res) => {
  try {
    console.log('📊 Admin analytics access granted to:', req.user.email);
    ...
    if (roomsResult.error) console.log('⚠️ Rooms table not available:', roomsResult.error.message);
    ...
    console.log(`✅ Admin analytics generated for ${req.user.email}`);
...
router.get('/reports', async (req, res) => {
  try {
    console.log('🛡️ Admin reports access granted to:', req.user.email);
...
router.put('/reports/:id', async (req, res) => {
  try {
    ...
    console.log('🛡️ Admin updating report:', reportId, 'by:', req.user.email);
...
router.get('/activity', async (req, res) => {
  try {
    ...
    console.log('📊 Admin activity access granted to:', req.user.email, 'limit:', limit);
